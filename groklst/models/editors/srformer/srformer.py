...
class SRFormer(BaseModule):
    ...
    paper: https://openaccess.thecvf.com/content/ICCV2023/papers/Zhou_SRFormer_Permuted_Self-Attention_for_Single_Image_Super-Resolution_ICCV_2023_paper.pdf
    code: https://github.com/HVision-NKU/SRFormer/tree/main
...
if __name__ == '__main__':
    ...
    # network structures for SRFormer_SRx2
    # network_g:
    # type: SRFormer
    # upscale: 2
    # in_chans: 3
