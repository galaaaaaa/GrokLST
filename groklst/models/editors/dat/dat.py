...
class DAT(BaseModule):
    """Dual Aggregation Transformer

    title: Dual Aggregation Transformer for Image Super-Resolution
    paper: https://openaccess.thecvf.com/content/ICCV2023/html/Chen_Dual_Aggregation_Transformer_for_Image_Super-Resolution_ICCV_2023_paper.html
    code: https://github.com/zhengchen1999/DAT/tree/main
...
if __name__ == '__main__':
    ...
    # network structures for train_DAT_x2
    # network_g:
    # type: DAT
    # upscale: 2
    # in_chans: 3
